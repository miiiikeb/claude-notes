...
export CACHE_BUST_FILES="home.js noteEditor.js noteDetail.js tasks.js marked.min.js dompurify.min.js quill.min.js quill.snow.css turndown.min.js notes.css"
